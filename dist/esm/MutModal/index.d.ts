...
export declare const MutModal: <Value, Res>({ serviceFn, formatSubmitValue, onSuccess, onError, onCancel, form, children, ...restModalProps }: FormModalConfig<Value, Res>) => JSX.Element;
export {};
